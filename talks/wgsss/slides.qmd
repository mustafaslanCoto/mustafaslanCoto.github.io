...
plt.ylabel("Occupancy", fontdict={"fontsize": 14})
plt.title("30-Day Bed Occupancy Forecast", fontdict={"fontsize": 16})
plt.legend()
plt.tight_layout()
plt.show()
```
...
axes.scatter(df.index, df["ward_0"], s=14, color="C0", alpha=0.5, zorder=1)
...
sns.scatterplot(data=holiday_data, x=holiday_data.index, y="ward_0",
                ax=axes, s=120, color="C1", edgecolor="white", linewidth=0.5,
...
axes.set_title("The effect of Public Holidays on Occupancy", fontsize=16)
