...
GT(f_metrics_forecast).tab_stub(groupname_col="metric").tab_style(
    ...
    style=[
        ...
        style.text(size="20px", color="#091717", weight="bold")
    ],
    locations=loc.row_groups()
).tab_style(
        style=style.text(size="20px", weight="bold"),
        locations=loc.column_labels()
    ).tab_style(
...
f_metrics_operat["metric"] = f_metrics_operat["metric"].replace({"Value of Stochastic Solution": "Cost of using model's solution"
})
