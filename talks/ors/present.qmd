...
format:
  revealjs:
    ...
    width: 1920
    height: 1080
    footer: "[Forecast all at once: A multi-series approach | OR Society Annual Conference 2026](https://mustafaslancoto.github.io)"
    slide-number: c/t
    preview-links: auto
    # chalkboard: true
...
- **Technical Debt:** Maintaining 58 separate models is resource-intensive and error-prone, especially when each model requires independent hyperparameter tuning and monitoring.

- **Scalability Issues:** As the number of specialties grows, the maintenance burden increases linearly, making it unsustainable for large hospitals with many interdependent streams.
:::
:::
::::
...
Generates 1-step ahead predictions for **all 58 series simultaneously**.
:::
:::
...
Produces a coherent $42 \times 58$ matrix of predictions:
...
:::{.column style="width: 50%; display: flex; flex-direction: column;"}
...
- **Data Source:** NHS Inpatient dataset (Jan 2021 – Feb 2026, $>133,000$ points).
...
| **Data Utilization** | $58 \times 2,300$ isolated observations | $133,000+$ collective panel rows | [**Greater statistical power**]{style="color: #20808D; font-weight: bold;"} |
