...
- Predictive effects describe how our (population best linear) predictions change when a value of [target regressor]{style="color: #1A6872;"} changes, holding all other regressors constant.
...
:::{style="padding: 10px; margin: 10px 0; border-left: 2px solid #1A6872; text-align: left; color: #1A6872;"}
[How does the predicted value of $Y$ change if $D$ increases by a unit while remains
...
::: {.fragment .fade-up}
:::{style="padding: 10px; margin: 10px 0; border-left: 2px solid #BF505C; text-align: left; color: #BF505C; font-weight: bold; font-size: 1.4em;"}
...
::: {.fragment .fade-up}
:::{style="padding: 10px; margin: 10px 0; border-left: 2px solid #9B6C22; text-align: left; color: #9B6C22; font-weight: bold; font-size: 1.4em;"}
...
:::{style="padding: 10px; margin: 10px 0; border-left: 2px solid #707C36; text-align: left; color: #707C36; font-weight: bold; font-size: 1.4em;"}
...
::: {.fragment .fade-up}
::: {style="padding: 10px; margin: 10px 0; text-align: left; font-size: 1.2em; font-weight: bold; border-left: 2px solid #1A6872; color: #1A6872;"}
...
:::{.fragment .fade-up}
:::{style="padding: 10px; margin: 10px 0; border-left: 2px solid #BF505C; text-align: left; color: #BF505C; font-weight: bold;"}
...
:::{.fragment .fade-up}
:::{style="padding: 10px; margin: 10px 0; border-left: 2px solid #707C36; text-align: left; color: #707C36; font-weight: bold;"}
...
*For the relevant code and data, go to [here](https://github.com/chamara7h/causal_inference_with_machine_learning_tutorial)*
:::
...
::: {.column width="33%"}
[![](images/causal_mlbook.png){width="100%"}](https://causalml-book.org/)
:::

::: {.column width="33%"}
[![](images/mixtape.png){width="100%"}](https://mixtape.scunning.com/)
:::

::: {.column width="33%"}
[![](images/causal_analy.avif){width="100%"}](https://mitpress.mit.edu/9780262545914/causal-analysis/)
:::
